...
A pipeline executa automaticamente de segunda a sexta às **03:00 BRT** (06:00 UTC) com o cenário `load` usando 50 VUs por 1 minuto (configuração reduzida para validação contínua).
